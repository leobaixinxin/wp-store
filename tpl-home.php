...
<div class="ed-container">
		...
		<div id="blog-section">
			...
			while($query->have_posts()):
				...
				<div class="blogs">
					...
					<span class="blog-comment"><i class="fa fa-comment-o"></i><?php echo get_comments_number().' '. __('Comments','wp-store');?></span><span class="blog-date"><i class="fa fa-clock-o"></i><?php echo get_the_date(('d,M,Y'),get_the_ID());?></span>
					<p><?php the_excerpt();?></p>
					<?php
					endif;
					?>
	...
	?>
		<div id="brand-section">
			...
			?>
			<h3 class="section-title"><span><?php echo $brand_title;?></span></h3>
			<?php

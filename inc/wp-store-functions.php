...
if( ! function_exists( 'wp_store_custom_header_tag_archive_page' ) ){
	function wp_store_custom_header_tag_archive_page($classes){
		...
		if(is_archive() && !is_category($blog_cat) ){
...
function wp_store_slider_section_cb(){
	...
	function wp_store_social_cb(){
		...
		<div class="social-icons ">
			...
			<a href="<?php echo __('skype:', 'wp-store').$skypelink; ?>" class="skype" data-title="Skype"><i class="fa fa-skype"></i><span></span></a>
			<?php } ?>
		</div>
		<?php
	}
			...
			<div class="payment-partner">
				<div class="store=wrapper">
					<?php if(!empty($payment_partner_1)): ?>
						<img id="partner_logo1" class="partner-logos" src="<?php echo esc_url($payment_partner_1)?>" alt="<?php _e('Partner Logo 1', 'wp-store') ?>" />
					<?php endif; ?>

					<?php if(!empty($payment_partner_2)): ?>
						<img id="partner_logo2" class="partner-logos" src="<?php echo esc_url($payment_partner_2)?>" alt="<?php _e('Partner Logo 2', 'wp-store') ?>" />
					<?php endif; ?>

					<?php if(!empty($payment_partner_3)): ?>
						<img id="partner_logo3" class="partner-logos" src="<?php echo esc_url($payment_partner_3)?>" alt="<?php _e('Partner Logo 3', 'wp-store') ?>" />
					<?php endif; ?>

					<?php if(!empty($payment_partner_4)): ?>
						<img id="partner_logo4" class="partner-logos" src="<?php echo esc_url($payment_partner_4)?>" alt="<?php _e('Partner Logo 4', 'wp-store') ?>" />
					<?php endif; ?>

					<?php if(!empty($ssl_seal)): ?>
						<img id="ssl_seal" class="partner-logos" src="<?php echo esc_url($ssl_seal)?>" alt="<?php _e('SSL Seal', 'wp-store') ?>" />
					<?php endif; ?>

					<?php if(!empty($other_seal_1)): ?>
						<img id="other_seal1" class="partner-logos" src="<?php echo esc_url($other_seal_1)?>" alt="<?php _e('Other Seal 1', 'wp-store') ?>" />
					<?php endif; ?>

					<?php if(!empty($other_seal_2)): ?>
						<img id="other_seal2" class="partner-logos" src="<?php echo esc_url($other_seal_2)?>" alt="<?php _e('Other Seal 2', 'wp-store') ?>" />
					<?php endif; ?>
				</div>
			</div>
			<?php
	...
	function wp_store_wrapper_before_products() {
		...
		echo '<div class="wp-store-products columns-'.$cols.'">';
	}
